            ...
            <div class="container">
                <div class="page-title-content text-center">
                    <div class="page-title-heading ">
                        <h3 class="title breadcrumb_heading">AR & VR</h3>
                    </div>
                    <div class="breadcrumbs">
                        <ul>
                            <li class=""><a href="index.php">Home</a></li>
                            <li class="text-white">Services</li>
                            <li class="text-white">AR & VR</li>
                        </ul>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8 col-sm-12">
                        <div class="wrap-service-detail pd-top-80"> 
                            ...
                            <img src="https://essitops.sirv.com/supremesite%20images/download.jpg" width="100%" alt="AR VR" class="mb-4">
