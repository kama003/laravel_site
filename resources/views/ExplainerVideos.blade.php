            ...
            <div class="container">
                <div class="page-title-content text-center">
                    <div class="page-title-heading ">
                        <h3 class="title breadcrumb_heading">Explainer Video</h3>
                    </div>
                    <div class="breadcrumbs">
                        <ul>
                            <li class=""><a href="/">Home</a></li>
                            <li class="text-white">Services</li>
                            <li class="text-white">Explainer Video</li>
                        </ul>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8 col-sm-12">
                        <div class="wrap-service-detail pd-top-80"> 
                             ...
                             <img src="https://essitops.sirv.com/supremesite%20images/Explainer%20video%20screenshot.jpg" alt="Image" class="mb-4">
