...
@section('title', 'Motion Graphic & VFX')
@section('content')
            ...
            <div class="container">
                <div class="page-title-content text-center">
                    <div class="page-title-heading ">
                        <h3 class="title breadcrumb_heading">Motion Graphic & VFX</h3>
                    </div>
                    <div class="breadcrumbs">
                         <ul>
                            <li class=""><a href="/">Home</a></li>
                            <li class="text-white">Services</li>
                            <li class="text-white">Motion Graphic & VFX</li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="content-wrap main-service-detail">
            <div class="container">
                <div class="row">
                      <x-servicelink></x-servicelink>
                    
                    <div class="col-lg-8 col-sm-12">
                        <div class="wrap-service-detail pd-top-80"> 
                           
                            <img class="mb-4" src="https://essitops.sirv.com/supremesite%20images/photo-1559077138-3e27e1cdb95a.webp" width="100%" alt="vfx">
