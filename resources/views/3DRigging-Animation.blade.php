...
@section('title', '3D Rigging & Animation')
@section('content')
            ...
            <div class="container">
                <div class="page-title-content text-center">
                    <div class="page-title-heading ">
                        <h3 class="title breadcrumb_heading">3D Rigging & Animation</h3>
                    </div>
                    <div class="breadcrumbs">
                        <ul>
                            <li class=""><a href="/">Home</a></li>
                            <li class="text-white">Services</li>
                            <li class="text-white">3D Rigging & Animation<</li>
                        </ul>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8 col-sm-12">
                        <div class="wrap-service-detail pd-top-80"> 
                            ...
                            <img src="https://essitops.sirv.com/supremesite%20images/2d3.png"  style="height:400px;width:100%;"alt="Image" class="mb-4">
