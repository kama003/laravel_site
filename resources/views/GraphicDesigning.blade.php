...
@section('title', 'Graphic Designing')
@section('content')
            ...
            <div class="container">
                <div class="page-title-content text-center">
                    <div class="page-title-heading ">
                        <h3 class="title breadcrumb_heading">Graphic Designing</h3>
                    </div>
                    <div class="breadcrumbs">
                        <ul>
                            <li class=""><a href="/">Home</a></li>
                            <li class="text-white">Services</li>
                            <li class="text-white">Graphic Designing</li>
                        </ul>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8 col-sm-12">
                        <div class="wrap-service-detail pd-top-80"> 
                            ...
                            <img src="https://essitops.sirv.com/supremesite%20images/photo-1500160503851-c04cefe545a9.webp" width="100%" alt="graphic" class="mb-4">
